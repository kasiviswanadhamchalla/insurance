package com.hackathon.common.config;
...
public class CommonSecurityConfig {
    ...
    public SecurityFilterChain commonSecurityFilterChain(HttpSecurity http) throws Exception {
        if ("api-gateway".equalsIgnoreCase(applicationName)) {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setExposedHeaders(List.of("Authorization", "Set-Cookie", "X-User-Name", "X-User-Roles"));
